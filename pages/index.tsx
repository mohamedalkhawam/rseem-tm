...
const Home: NextPage = () => {
  ...
  useEffect(()=>{
    homeAnimate([logoRef,titleCircleRef,titleRef,bodyRef,buttonRef,buttonCircleRef,navRef,navCircleRef])
  },[])
          ...
          <div className="mx-auto lg:mx-0 w-[90%] sm:w-[60%] lg:w-[45%] lg:pl-[10%] mt-[5%] mb-[10%] ">
            <div>
              <div className=" relative mb-6">
                <h2 ref={titleRef} className=" font-cake font-bold text-4xl text-white relative z-[1] tracking-wide first-letter:text-[4.3rem] first-letter:mr-5">
                  Lorem ipsum
                </h2>
                <div ref={titleCircleRef} className="absolute w-[4rem] h-[4rem] bg-primary-100 rounded-full -top-2 -left-4 firs" />
              </div>
              <p ref={bodyRef} className="font-myriad font-normal text-white pl-12">
            ...
            <div className="group flex justify-end mt-8 ml-auto w-[16rem] ">
                <div ref={buttonCircleRef} className="relative flex  justify-center w-9 h-9 bg-primary-100 rounded-full z-[10] group-hover:bg-white mr-2 transition-[margin] duration-300 " >
                  <Image src='/rLogo2.png' alt='logo' width='30' height='23' className='transitition-all duration-500 opacity-0 group-hover:opacity-100 transform group-hover:rotate-[360deg] '/>
                </div>
              <button ref={buttonRef} className="bg-white px-12  rounded-full z-[11] font-myriad font-normal relative">
                FIND OUT MORE
              </button>
            </div>
          </div>
