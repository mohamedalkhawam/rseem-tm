...
import { fadeX, swiperAnimation, swiperContentsAnimation,swiperContentsAnimations } from "../utils/gsapAiamtiom/gsap";

const Dummy = ({swiperSlideRef,swiperImgRef,swiperDescRef,swiperNameRef}:any) => {
  ...
  return (
    <div ref={swiperSlideRef} className="h-full  flex flex-col items-center  ">
      ...
      <p ref={swiperDescRef} className="font-myriad font-light text-white leading-5 mt-4 w-[90%] max-w-[600px] ">
        Lorem Ipsum Dolor Sit Amet, Consectetuer Adipiscing Elit, Sed Diam
        Nonummy Nibh Euismod Lorem Ipsum Dolor Sit Amet, Consectetuer Adipiscing
        Elit,{" "}
      </p>
      <p ref={swiperNameRef} className="font-myriad font-light text-white leading-5 mt-6">
        Ahmad Ahmad
      </p>
    </div>
  );
  ...
  return (
    <div className="relative min-h-[120vh] sm:min-h-[100vh] text-center px-2 sm:px-8">
      <div 
        ...
        style={{width:`calc(100% + 4 * 10vw )`,transform:`translateX(${10 * curSlide}vw)`}} 
      />
      <h3 ref={titleRef} className="font-cake font-thin text-5xl text-white pt-16">Reviews</h3>
      <p ref={bodyRef} className="font-myriad font-light text-white leading-5 mt-8 sm:w-1/2 mx-auto mb-32">
        Lorem Ipsum Dolor Sit Amet, Consectetuer Adipiscing Elit, Sed Diam
        Nonummy Nibh Euismod Lorem Ipsum Dolor Sit Amet, Consectetuer Adipiscing
        Elit,{" "}
      </p>
      <div className="relative">
        ...
        <div ref={swiperRef} className=" sm:px-[10%] h-auto ">
          ...
          {
            [1,2,3,4].map((item,i)=>
              <div key={i} className={`snap-center w-full shrink-0 transition-opacity duration-700 ${i===curSlide?'opacity-100':'opacity-0'}`} >
              <Dummy />
            </div>)
          }
          </div>
