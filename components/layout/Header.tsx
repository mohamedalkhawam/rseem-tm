...
const Header = ({passRef1,passRef2}:headerType) => {
  ...
  return (
    <div className="relative z-50">
        <nav ref={passRef1} className="relative hidden lg:flex  rounded-full w-[50rem]  justify-center items-center bg-white mx-auto">
          <div ref={passRef2} className="absolute group flex items-center justify-center -left-20  w-[56px] h-[56px]  cursor-pointer ">
      ...
      >
        <div ref={headerLogoRef} className=" w-[140px] h-[50px] lg:w-[200px] lg:h-[75px] shrink-0">
        ...
        <div ref={headerChatRef} className=" w-[56px] h-full group cursor-pointer ml-20">
          <BiSupport
            size={56}
